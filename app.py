...
from langchain.llms import Ollama  # CHANGED here
...
def generate_story_from_text(scenario: str) -> str:
    ...
    llm: Any = Ollama(model="llama2", temperature=0.7)  # CHANGED here
...
def main() -> None:
    ...
    with st.sidebar:
        st.write("---")
        st.write("AI App created by @ Roshan Manick")
